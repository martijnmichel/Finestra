...
export const AboutApp = () => {
  return (
    <div className="p-3 h-full overflow-y-auto">
      <h1 className="text-2xl">Martijn van der Eijk</h1>
      ...
      accident, sometimes on purpose (injected humour and the like). Lorem Ipsum
      ...
      purpose (injected humour and the like). Lorem Ipsum is simply dummy text
